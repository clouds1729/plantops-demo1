import { calculateIpc } from './calculations.ipc'
...
export function calculateIpcFromDomain(logs: DailyLog[], rates: Rate[], plants: Plant[]) { return calculateIpc(logs,rates,plants) }
